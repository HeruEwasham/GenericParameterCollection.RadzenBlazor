...
namespace YngveHestem.GenericParameterCollection.RadzenBlazor
{
    public class TooltipOptionsConverter : ParameterCollectionParameterConverter<TooltipOptions>
    {
        ...
        protected override bool CanConvertToParameterCollection(TooltipOptions value)
        {
            return value != null;
        }

        protected override TooltipOptions ConvertFromParameterCollection(ParameterCollection value)
        {
        ...
        protected override ParameterCollection ConvertToParameterCollection(TooltipOptions value)
        {
            var duration = 0;
            var delay = 0;
